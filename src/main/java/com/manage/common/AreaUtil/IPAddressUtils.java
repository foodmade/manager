package com.manage.common.AreaUtil;
...
public class IPAddressUtils {
     ...
     * 纯真IP数据库保存的文件夹
     */
    private String INSTALL_DIR=this.getClass().getResource("/").getPath();
    ...
    public void init() {
        try {
            ...
            try {
                ...
                System.out.println("file:"+INSTALL_DIR);
